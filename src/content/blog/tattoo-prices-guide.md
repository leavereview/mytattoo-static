...
**Pros**: Fair compensation for complex work, accounts for difficulty
**Cons**: Clients may feel uncertain about final cost, slower artists benefit

### Flat Rate/Per Piece

Quote a fixed price based on design complexity and size:

**Pros**: Clients know exactly what they'll pay, encourages efficient work
**Cons**: Can lose money on difficult pieces, requires accurate estimation
