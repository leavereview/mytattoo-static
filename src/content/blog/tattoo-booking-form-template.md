...
description: "What every tattoo booking form should ask (size, placement, references, consent) and the optional fields that cut back-and-forth before the consultation."
...
A well-designed tattoo booking form saves time, reduces back-and-forth communication, and sets proper expectations before clients arrive. Whether you use paper forms, online forms, or [booking software](/tattoo-booking-software/), knowing what information to collect is essential.
...
| Field | Purpose |
|-------|---------|
| Full name | Legal records, identification |
| Phone | Appointment reminders, quick contact |
| Email | Confirmations, reference sharing |
| Date of birth | Age verification (must be 18+) |

**Best practice:**
Request preferred contact method and best times to reach them.
...
**Why this matters:**
Health information affects safety and results. Some conditions require precautions or may contraindicate tattooing.
...
**Why ask:**
Experienced clients have different needs than first-timers. Previous reactions inform precautions.
...
**Benefit:**
Ensures realistic expectations before time is invested.
...
**Business value:**
Understanding where clients come from helps focus marketing efforts.
...
- [Deposit policy](/blog/tattoo-deposit-guide/) and cancellation terms
- Age requirement (18+)
- Health disclosure accuracy
- Photo/portfolio usage permission

**Sample text:**
*"I confirm I am 18 years of age or older. I understand the deposit of £[amount] is non-refundable if I cancel with less than [X] hours notice. I have disclosed all relevant health information accurately."*
...
**Benefit:**
Clear permission upfront avoids awkward conversations later.
...
[Get started](https://app.mytattoo.software/signin) and see how streamlined booking improves your studio.
